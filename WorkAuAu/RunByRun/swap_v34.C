...
void swap_v34()
{
  ...
  for ( int i = 0; i < nbins; ++i )
    {
      ...
      sub1_v3[i] = pow(-sub1_c3[i],0.25);
      sub1_ev3[i] = (1/(4*pow(-sub1_c3[i],0.75)))*sub1_ec3[i];
      ...
      sub2_v3[i] = pow(-sub2_c3[i],0.25);
      sub2_ev3[i] = (1/(4*pow(-sub2_c3[i],0.75)))*sub2_ec3[i];
      ...
      sub3_v3[i] = pow(-sub3_c3[i],0.25);
      sub3_ev3[i] = (1/(4*pow(-sub3_c3[i],0.75)))*sub3_ec3[i];
      ...
      sub4_v3[i] = pow(-sub4_c3[i],0.25);
      sub4_ev3[i] = (1/(4*pow(-sub4_c3[i],0.75)))*sub4_ec3[i];
      ...
      sub5_v3[i] = pow(-sub5_c3[i],0.25);
      sub5_ev3[i] = (1/(4*pow(-sub5_c3[i],0.75)))*sub5_ec3[i];
  ...
  leg->Draw();
  c1->Print("v34_phase2.png");
  c1->Print("v34_phase2.pdf");
  ...
  leg->SetTextSize(0.05);
  leg->Draw();
  c1->Print("v34_phase1.png");
  c1->Print("v34_phase1.pdf");
