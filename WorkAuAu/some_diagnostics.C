...
void track_parameters()
{
  ...
  th1d_chi2->GetXaxis()->SetTitle("#chi^{2}/ndf");
  th1d_chi2->Draw();
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_chi2->GetXaxis()->SetTitle("#chi^{2}/ndf");
      th1d_cent_chi2->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_chi2-%d.png",i));
    }

  // --- dcax
  TH2D* th2d_dcax = (TH2D*)file->Get("th2d_cent_dcax");
  TH1D* th1d_dcax = th2d_dcax->ProjectionY("th1d_dcax",1,100);
  th1d_dcax->GetXaxis()->SetTitle("DCA_{X}");
  th1d_dcax->Draw();
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_dcax->GetXaxis()->SetTitle("DCA_{X}");
      th1d_cent_dcax->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_dcax-%d.png",i));
    }

  // --- dcay
  TH2D* th2d_dcay = (TH2D*)file->Get("th2d_cent_dcay");
  TH1D* th1d_dcay = th2d_dcay->ProjectionY("th1d_dcay",1,100);
  th1d_dcay->GetXaxis()->SetTitle("DCA_{Y}");
  th1d_dcay->Draw();
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_dcay->GetXaxis()->SetTitle("DCA_{Y}");
      th1d_cent_dcay->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_dcay-%d.png",i));
    }
  ...
  th1d_nhitr->GetXaxis()->SetTitle("Number of hits (FVTX+VTX)");
  th1d_nhitr->Draw();
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_nhitr->GetXaxis()->SetTitle("Number of hits (FVTX+VTX)");
      th1d_cent_nhitr->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_nhitr-%d.png",i));
    }
  ...
  th1d_nhits->GetXaxis()->SetTitle("Number of hits (FVTX only)");
  th1d_nhits->Draw();
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_nhits->GetXaxis()->SetTitle("Number of hits (FVTX only)");
      th1d_cent_nhits->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_nhits-%d.png",i));
    }
...
void track_coordinates()
{
  ...
  th1d_before_phi->GetXaxis()->SetTitle("#phi");
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_before_phi->GetXaxis()->SetTitle("#phi");
      th1d_cent_before_phi->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_before_phi-%d.png",i));
    }
  ...
  th1d_after_phi->GetXaxis()->SetTitle("#phi");
  th1d_after_phi->Draw();
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_after_phi->GetXaxis()->SetTitle("#phi");
      th1d_cent_after_phi->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_after_phi-%d.png",i));
    }
  ...
  th1d_aafter_phi->GetXaxis()->SetTitle("#phi");
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_aafter_phi->GetXaxis()->SetTitle("#phi");
      th1d_cent_aafter_phi->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_aafter_phi-%d.png",i));
    }
  ...
  th1d_before_eta->GetXaxis()->SetTitle("#eta");
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_before_eta->GetXaxis()->SetTitle("#eta");
      th1d_cent_before_eta->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_before_eta-%d.png",i));
    }
  ...
  th1d_after_eta->GetXaxis()->SetTitle("#eta");
  th1d_after_eta->Draw();
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_after_eta->GetXaxis()->SetTitle("#eta");
      th1d_cent_after_eta->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_after_eta-%d.png",i));
    }
  ...
  th1d_aafter_eta->GetXaxis()->SetTitle("#eta");
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_aafter_eta->GetXaxis()->SetTitle("#eta");
      th1d_cent_aafter_eta->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_aafter_eta-%d.png",i));
    }
...
void track_coordinates_rebinned()
{
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_before_phi->GetXaxis()->SetTitle("#phi");
      th1d_cent_before_phi->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_before_phi_R-%d.png",i));
    }
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_after_phi->GetXaxis()->SetTitle("#phi");
      th1d_cent_after_phi->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_after_phi_R-%d.png",i));
    }
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_aafter_phi->GetXaxis()->SetTitle("#phi");
      th1d_cent_aafter_phi->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_aafter_phi_R-%d.png",i));
    }
  ...
  th1d_before_eta->GetXaxis()->SetTitle("#phi");
  th1d_before_eta->Draw();
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_before_eta->GetXaxis()->SetTitle("#eta");
      th1d_cent_before_eta->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_before_eta_R-%d.png",i));
    }
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_after_eta->GetXaxis()->SetTitle("#eta");
      th1d_cent_after_eta->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_after_eta_R-%d.png",i));
    }
  ...
  for ( int i = 0; i < 100; ++i )
    {
      ...
      th1d_cent_aafter_eta->GetXaxis()->SetTitle("#eta");
      th1d_cent_aafter_eta->Draw();
      c1->Print(Form("FigsDiagnostics/Centrality/th1d_cent_aafter_eta_R-%d.png",i));
    }
