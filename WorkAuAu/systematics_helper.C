...
void crunch_cumu4(TProfile*, TProfile*, TProfile*, TProfile*, const char*, int);
...
void crunch_cumu4(TProfile* for_base, TProfile* two_base, TProfile* for_eval, TProfile* two_eval, const char* systype, int harmonic)
{
