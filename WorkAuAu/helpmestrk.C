void helpmestrk()
{
  ...
  c1->Print("FigsFour/strk_acceptance_AuAu.png");
  c1->Print("FigsFour/strk_acceptance_AuAu.pdf");
  ...
  c1->Print("FigsFour/strk_acceptance_AuAu_v22andterms.png");
  c1->Print("FigsFour/strk_acceptance_AuAu_v22andterms.pdf");
  ...
  c1->Print("FigsFour/strk_acceptance_AuAu_v22gapandterms.png");
  c1->Print("FigsFour/strk_acceptance_AuAu_v22gapandterms.pdf");
  ...
  c1->Print("FigsFour/strk_acceptance_AuAu_c22gapandterms.png");
  c1->Print("FigsFour/strk_acceptance_AuAu_c22gapandterms.pdf");
