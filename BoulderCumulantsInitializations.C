...
int BoulderCumulants::Init(PHCompositeNode *topNode)
{
  ...
  th1d_track_before_eta = new TH1D("th1d_track_before_eta","",2000, -0.1, 0.1);
  th1d_track_before_phi = new TH1D("th1d_track_before_phi","",2000, -0.1, 0.1);
  th1d_track_after_eta = new TH1D("th1d_track_after_eta","",2000, -0.1, 0.1);
  th1d_track_after_phi = new TH1D("th1d_track_after_phi","",2000, -0.1, 0.1);
