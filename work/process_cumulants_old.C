...
void do_process(const char* type, int rebin)
{
  ...
  TProfile* tp1f_G_two = (TProfile*)fin->Get("nfvtxt_os_fvtxsfvtxn_tracks_c22"); // scalar product north*south
  TProfile* tp1f_cos1_north = (TProfile*)fin->Get("nfvtxt_os_fvtxn_tracks_cos21");
  TProfile* tp1f_sin1_north = (TProfile*)fin->Get("nfvtxt_os_fvtxn_tracks_sin21");
  TProfile* tp1f_cos1_south = (TProfile*)fin->Get("nfvtxt_os_fvtxs_tracks_cos21");
  TProfile* tp1f_sin1_south = (TProfile*)fin->Get("nfvtxt_os_fvtxs_tracks_sin21");
