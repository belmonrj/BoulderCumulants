void simple_six_strk()
{
  ...
  leg->Draw();
  c1->Print(Form("FigsSix/strk_sixparticle_components_blah.png"));
  c1->Print(Form("FigsSix/strk_sixparticle_components_blah.pdf"));
  ...
  th1d_123->Draw("same ex0p");
  leg->Draw();
  c1->Print(Form("FigsSix/strk_sixparticle_components_zoom_blah.png"));
  c1->Print(Form("FigsSix/strk_sixparticle_components_zoom_blah.pdf"));
  ...
  leg->Draw();
  c1->Print(Form("FigsSix/strk_sixparticle_cumulant_blah.png"));
  c1->Print(Form("FigsSix/strk_sixparticle_cumulant_blah.pdf"));
  ...
  leg->Draw();
  c1->Print(Form("FigsSix/strk_sixparticle_v2_blah.png"));
  c1->Print(Form("FigsSix/strk_sixparticle_v2_blah.pdf"));
  ...
  leg->Draw();
  c1->Print(Form("FigsSix/strk_sixparticle_v2642_blah.png"));
  c1->Print(Form("FigsSix/strk_sixparticle_v2642_blah.pdf"));
